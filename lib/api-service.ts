...
// Helper function to handle API responses in React.ts routes
export function handleApiResponse<T>(data: T): NextResponse<T> {
  return NextResponse.json(data);
}

// Helper function to handle API errors in React.ts routes
