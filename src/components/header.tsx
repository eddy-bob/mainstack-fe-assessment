...
export function Header({ onAppsClick }: HeaderProps) {
  ...
  const navItems = [
    { label: "Home", href: "/", icon: <img src="/header-icon-0.svg" alt="Home" width={20} height={20} /> },
    { label: "Analytics", href: "/analytics", icon: <img src="/header-icon-1.svg" alt="Analytics" width={20} height={20} /> },
    { label: "Revenue", href: "/revenue", icon: <img src="/header-icon-2.svg" className="invert" alt="Revenue" width={20} height={20} /> },
    { label: "CRM", href: "/crm", icon: <img src="/header-icon-3.svg" alt="CRM" width={20} height={20} /> },
  ]
      ...
      <header className=" bg-white rounded-[40px] shadow-md sticky top-3  ">
        <div className="px-3 sm:px-4 lg:px-6 py-3 sm:py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
             <img src="/mainstack-logo.svg" alt="Logo" width={32} height={32} />
          </div>
          ...
          <nav className="hidden sm:flex items-center gap-1 lg:gap-2">
            ...
            >
              <div className={`transition-all duration-200 ${
                ...
                <img src="/header-icon-4.svg" alt="Apps" width={20} height={20} />
              </div>
              Apps
          ...
          <div className="flex items-center gap-3">
            ...
            <Button
              ...
              onClick={onAppsClick}
            >
              <img src="/chat.svg" alt="Profile" width={42} height={42} />
            </Button>
