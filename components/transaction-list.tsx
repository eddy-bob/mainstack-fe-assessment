  ...
  const filteredTransactions = transactions?.filter((transaction) => {
    ...
    if (dateRange) {
      ...
      console.log('Date filtering debug:', {
        ...
        startDate,
        endDate,
        isInRange: transactionDate >= startDate && transactionDate <= endDate,
      ...
      <div className="space-y-6 sm:pt-20 pt-10">
        ...
        {filteredTransactions.length === 0 ? (
          <TransactionEmptyState
            ...
            icon={<Image src="/receipt-long.svg" alt="Empty State" width={30} height={30}/>}
          ...
          <div className="space-y-2">
            {filteredTransactions.map((transaction, index) => (
              <div
                ...
                className="flex items-center justify-between py-4 bg-card rounded-2xl hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 cursor-pointer"
              >
